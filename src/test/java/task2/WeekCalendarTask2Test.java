...
public class WeekCalendarTask2Test {
    ...
    public void week_calendar_print_test() {
        ...
        assertThat(new WeekCalendarTask2("2020-01-09").formatTextOutPut(), is(excepted));
    }
    ...
    public void form_html_output_test() {
        ...
        assertThat(new WeekCalendarTask2("2020-01-09").formatHtmlOutPut(), is(excepted));
    }

    @Test
    public void parse_date_to_week_dates_test() {
        String[] weekDatesResult = new WeekCalendarTask2("2020-01-09").parseToWeekDates("2020-01-09");
